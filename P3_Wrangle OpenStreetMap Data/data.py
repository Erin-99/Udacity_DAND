...
def process_map(file_in, validate):
    ...
    with codecs.open(NODES_PATH, 'w') as nodes_file, \
        ...
        nodes_file.write(codecs.BOM_UTF8)
        nodes_tags_file.write(codecs.BOM_UTF8)
        ways_file.write(codecs.BOM_UTF8)
        way_nodes_file.write(codecs.BOM_UTF8)
        way_tags_file.write(codecs.BOM_UTF8)
